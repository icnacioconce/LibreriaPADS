...
<head>
	<meta charset="utf-8"/>
	<title>Librerias Pads | Rayuela</title>
...
<body>
	...
	<div>
		<p>
				<a href="../imagenes/libros/libro8.png"><img style="width: 12.5em; height: 20em"  src="../imagenes/libros/libro8.png" alt="Rayuela"></a>
		</p>
	</div>
	...
	<div>
		<form name="agenda" method="POST" action="Rayuela.php">
        ...
        <?php
                ...
                if(!$contactos = simplexml_load_file('Rayuela_comentarios.xml')){
        ...
        <?php
            if(isset($_POST['enviar'])){
                ...
                $doc -> load("Rayuela_comentarios.xml");
                ...
                $doc -> save("Rayuela_comentarios.xml");

                echo '<META HTTP-EQUIV="REFRESH" CONTENT="0;URL=Rayuela.php"';
            }
        ?>
	</div>
</body>
