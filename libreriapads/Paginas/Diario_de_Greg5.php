...
<head>
	<meta charset="utf-8"/>
	<title>Librerias Pads | Diario de Greg 5. La cruda realidad</title>
...
<body>
	...
	<div>
		<p>
				<a href="../imagenes/libros/libro13.png"><img style="width: 12.5em; height: 20em"  src="../imagenes/libros/libro13.png" alt="Diario de Greg5"></a>
		</p>
	</div>
	...
	<div>
		<form name="agenda" method="POST" action="Diario_de_Greg5.php">
        ...
        <?php
                ...
                if(!$contactos = simplexml_load_file('Diario_de_Greg5_comentarios.xml')){
        ...
        <?php
            if(isset($_POST['enviar'])){
                ...
                $doc -> load("Diario_de_Greg5_comentarios.xml");
                ...
                $doc -> save("Diario_de_Greg5_comentarios.xml");

                echo '<META HTTP-EQUIV="REFRESH" CONTENT="0;URL=Diario_de_Greg5.php"';
            }
        ?>
	</div>
</body>
